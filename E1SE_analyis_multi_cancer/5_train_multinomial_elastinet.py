...
# -----------------------------
train = pd.read_csv("/scratch/home/gbhogal/CS298/cfDNA/matrices/train.csv")
...
joblib.dump(
    ...
    "/scratch/home/gbhogal/CS298/cfDNA/models/multinomial_elasticnet.pkl"
)
...
for i, cls in enumerate(classes):
    ...
    y_score = y_val_proba[:, i]

    precision, recall, _ = precision_recall_curve(y_true_binary, y_score)
    pr_auc = auc(recall, precision)

    pr_aucs[cls] = pr_auc
    print(f"PR-AUC ({cls} vs rest):", round(pr_auc, 4))
